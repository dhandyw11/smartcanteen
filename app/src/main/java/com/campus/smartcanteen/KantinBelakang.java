...
public class KantinBelakang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kantin_belakang);
        ...
        FloatingActionButton floatingActionButton = findViewById(R.id.float_cart_belakang);
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cartIntent = new Intent(KantinBelakang.this,Cart.class);
                startActivity(cartIntent);
            }
        });

        recycler_menu = findViewById(R.id.kantin_belakang_recycler);
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Kategori model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent foodList = new Intent(KantinBelakang.this,FoodList.class);
